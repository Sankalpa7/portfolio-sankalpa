  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 right-0 w-96 h-96 bg-cyan-500/8 dark:bg-cyan-500/5 rounded-full blur-3xl" />
      </div>

      <div className="max-w-6xl mx-auto px-6 md:px-10 xl:px-24 relative z-10 pb-16">
        {/* Section header */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-14 items-start">
          ...
          <div className="flex flex-col gap-8">
            <div className="space-y-5">
              <p
                className="text-sm leading-7 text-slate-600 dark:text-zinc-400"
            ...
            <div className="border border-slate-200 dark:border-zinc-800 rounded-2xl p-6 bg-white/70 dark:bg-zinc-900/50 backdrop-blur">
              ...
              <p className="text-sm font-mono text-slate-700 dark:text-zinc-300 leading-6">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              {stats.map((stat) => (
                ...
                >
                  ...
                  <div className="text-xs font-mono text-slate-500 dark:text-zinc-500 group-hover:text-slate-700 dark:group-hover:text-zinc-300 transition-colors">
                    {stat.label}
                  </div>
                </div>
              ))}
            ...
            {/* Quick facts */}
            <div className="border border-slate-200 dark:border-zinc-800 rounded-2xl overflow-hidden bg-white/70 dark:bg-transparent backdrop-blur">
              <div className="px-6 py-4 border-b border-slate-200 dark:border-zinc-800 bg-slate-50/70 dark:bg-zinc-900/50">
                <span className="text-xs font-mono text-slate-500 dark:text-zinc-400 tracking-widest uppercase">
                  {t.about.quick_facts}
                </span>
              </div>
              ...
              <div className="divide-y divide-slate-200/60 dark:divide-zinc-800/50">
                {facts.map((fact) => (
                  ...
                  >
                    ...
                    <span className="text-sm font-mono text-slate-800 dark:text-zinc-300 group-hover:text-cyan-700 dark:group-hover:text-cyan-400 transition-colors">
                      {fact.value}
                    </span>
                  </div>
                ))}
      ...
      <div className="relative w-full mt-8">
        <div className="flex items-center justify-center mb-6 px-6 md:px-10 xl:px-24">
        ...
        <div className="relative border-y border-slate-200 dark:border-zinc-800 py-5 overflow-hidden bg-white/50 dark:bg-zinc-900/20 backdrop-blur">
          ...
          <div className="flex animate-marquee-about whitespace-nowrap">
            {[...hobbies, ...hobbies, ...hobbies].map((h, i) => (
              <div key={i} className="flex items-center gap-2.5 mx-6 shrink-0 group cursor-default">
                ...
                <span className="text-xs font-mono text-slate-600 dark:text-zinc-400 group-hover:text-cyan-700 dark:group-hover:text-cyan-400 transition-colors duration-200 tracking-wide">
                  {h.label}
                </span>
                <span className="ml-4 text-slate-300 dark:text-zinc-700 text-lg">✦</span>
              </div>
            ))}
          </div>
        </div>

        <div className="h-8 bg-gradient-to-b from-white/50 dark:from-zinc-900/20 to-transparent" />
      </div>
